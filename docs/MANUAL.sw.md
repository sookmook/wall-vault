...
> 💡 **Ikiwa huduma ya ndani inaendesha kwenye kompyuta nyingine**: Ingiza IP ya kompyuta hiyo kwenye sehemu ya kuingiza URL ya huduma. Mfano: `http://192.168.0.6:11434` (Ollama), `http://192.168.0.6:1234` (LM Studio). Ikiwa huduma imefungwa kwa `127.0.0.1` tu badala ya `0.0.0.0`, kufikia kwa IP ya nje hakutafanya kazi, kwa hivyo angalia anwani ya kufunga kwenye usanidi wa huduma.
