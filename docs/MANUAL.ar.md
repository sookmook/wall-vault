...
- **Base URL**: `http://عنوان_الوكيل:56244/v1`
  ...
  - على جهاز آخر (مثل خادم Mini): `http://192.168.0.6:56244/v1`
...
> 💡 **إذا كانت الخدمة المحلية تعمل على حاسوب آخر**: أدخل عنوان IP ذلك الحاسوب في حقل URL الخدمة. مثال: `http://192.168.0.6:11434` (Ollama)، `http://192.168.0.6:1234` (LM Studio). إذا كانت الخدمة مرتبطة بـ `127.0.0.1` فقط وليس `0.0.0.0`، لن يعمل الوصول عبر IP خارجي — تحقق من عنوان الربط في إعدادات الخدمة.
