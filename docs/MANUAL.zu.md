...
> 💡 **Uma insizakalo yasekhaya isebenza kwenye ikhompyutha**: Faka i-IP yaleyo khompyutha kubhokisi le-URL yensizakalo. Isibonelo: `http://192.168.1.20:11434` (Ollama), `http://192.168.1.20:1234` (LM Studio). Uma insizakalo iboshwe ku-`127.0.0.1` hhayi ku-`0.0.0.0`, ngeke ikwazi ukufinyelelwa nge-IP yangaphandle, ngakho hlola ikheli lokuboshwa kumasethwa ensizakalo.
