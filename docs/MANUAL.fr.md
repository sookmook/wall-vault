...
- **Base URL** : `http://adresse-du-proxy:56244/v1`
  ...
  - Machine differente (ex : Mac Mini) : `http://192.168.0.6:56244/v1`
...
> 💡 **Si le service local fonctionne sur un autre ordinateur** : Entrez l'IP de cet ordinateur dans le champ URL du service. Exemple : `http://192.168.0.6:11434` (Ollama), `http://192.168.0.6:1234` (LM Studio). Si le service est lie uniquement a `127.0.0.1` au lieu de `0.0.0.0`, l'acces par IP externe ne fonctionnera pas — verifiez le parametre d'adresse de liaison du service.
