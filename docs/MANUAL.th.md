...
*(อัปเดตล่าสุด: 2026-04-05 — v0.1.22)*
...
## การเปลี่ยนแปลงล่าสุด (v0.1.16 ~ v0.1.22)

### v0.1.22 (2026-04-05)
- **แก้ไข: ฟิลด์ content ว่างถูกตัดออก**: เมื่อโมเดลการคิด (gemini-3.1-pro, o1, claude thinking ฯลฯ) ใช้ max_tokens หมดในการให้เหตุผลก่อนที่จะสร้างผลลัพธ์ พร็อกซีจะตัดฟิลด์ `content`/`text` ที่ว่างเปล่าออกผ่าน `omitempty` ไคลเอนต์ของ OpenAI/Anthropic SDK (Claude Code, Cline ฯลฯ) แครชด้วย "Cannot read properties of undefined (reading 'trim')" ตอนนี้ฟิลด์จะถูกส่งออกเสมอตามข้อกำหนด API อย่างเป็นทางการ
