...
- **Base URL**: `http://DIRECCION_PROXY:56244/v1`
  ...
  - Otra máquina (ej.: Mac Mini): `http://192.168.1.20:56244/v1`
...
> 💡 **Si tu servicio local se ejecuta en otra computadora**: Introduce la IP de esa computadora en el campo de URL del servicio. Ejemplo: `http://192.168.1.20:11434` (Ollama), `http://192.168.1.20:1234` (LM Studio). Si el servicio solo está vinculado a `127.0.0.1` en lugar de `0.0.0.0`, el acceso por IP externa no funcionará — verifica la dirección de vinculación en la configuración del servicio.
