...
- **Base URL**: `http://alamat-proxy:56244/v1`
  ...
  - Di mesin lain seperti server mini: `http://192.168.0.6:56244/v1`
...
> 💡 **Jika layanan lokal berjalan di komputer lain**: Masukkan IP komputer tersebut di kolom URL layanan. Contoh: `http://192.168.0.6:11434` (Ollama), `http://192.168.0.6:1234` (LM Studio). Jika layanan hanya terikat ke `127.0.0.1` bukan `0.0.0.0`, tidak dapat diakses melalui IP eksternal — periksa alamat binding di pengaturan layanan.
