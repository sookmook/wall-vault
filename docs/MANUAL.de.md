...
- **Base URL**: `http://Proxy-Adresse:56244/v1`
  ...
  - Andere Maschine (z. B. Mac Mini): `http://192.168.0.6:56244/v1`
...
> 💡 **Falls der lokale Dienst auf einem anderen Computer läuft**: Gib die IP dieses Computers im Dienst-URL-Feld ein. Beispiel: `http://192.168.0.6:11434` (Ollama), `http://192.168.0.6:1234` (LM Studio). Wenn der Dienst nur an `127.0.0.1` statt `0.0.0.0` gebunden ist, funktioniert der Zugriff über eine externe IP nicht — überprüfe die Bindungsadresse in den Diensteinstellungen.
