...
> 💡 **If your local service is running on a different machine**: Enter that machine's IP in the service URL field. For example: `http://192.168.0.6:11434` (Ollama), `http://192.168.0.6:1234` (LM Studio)
