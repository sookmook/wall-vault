...
*Last updated · 최종 업데이트: 2026-03-16 — v0.1.7 (dashboard title "벽금고(wall-vault) 대시보드", logo to sticky topbar, today_attempts tracking, HTTP 582 cooldown 5min, share-of-total bar scaling, custom/ routing fix, Ollama Timeout:0, key_att i18n, avatar heartbeat sync, deploy hardening)*
