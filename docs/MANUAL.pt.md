...
- **Base URL**: `http://endereco-do-proxy:56244/v1`
  ...
  - Em outra maquina como servidor mini: `http://192.168.0.6:56244/v1`
...
> 💡 **Se o servico local estiver em execucao em outro computador**: Insira o IP desse computador no campo de URL do servico. Ex: `http://192.168.0.6:11434` (Ollama), `http://192.168.0.6:1234` (LM Studio). Se o servico estiver vinculado apenas a `127.0.0.1` em vez de `0.0.0.0`, nao sera acessivel pelo IP externo — verifique o endereco de binding nas configuracoes do servico.
