...
- **Troca automática de serviço (fallback)**: se o Google não responder, o wall-vault tenta o OpenRouter; se esse também falhar, usa o Ollama (IA local na sua máquina). A sessão não cai.
...
- **Base URL**: `http://endereco-do-proxy:56244/v1`
  ...
  - Em outro dispositivo (ex.: Mac Mini): `http://192.168.1.20:56244/v1`
...
> 💡 **Se o serviço local estiver rodando em outro computador**: insira o IP daquela máquina no campo de URL do serviço. Exemplos: `http://192.168.1.20:11434` (Ollama), `http://192.168.1.20:1234` (LM Studio)
