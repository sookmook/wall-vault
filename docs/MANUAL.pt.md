...
- **Base URL**: `http://endereço-do-proxy:56244/v1`
  ...
  - Em outra máquina como servidor mini: `http://192.168.1.20:56244/v1`
...
> 💡 **Se o serviço local estiver em execução em outro computador**: Insira o IP desse computador no campo de URL do serviço. Ex: `http://192.168.1.20:11434` (Ollama), `http://192.168.1.20:1234` (LM Studio). Se o serviço estiver vinculado apenas a `127.0.0.1` em vez de `0.0.0.0`, não será acessível pelo IP externo — verifique o endereço de binding nas configurações do serviço.
