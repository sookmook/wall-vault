...
- **Base URL**: `http://direccion-del-proxy:56244/v1`
  ...
  - Maquina diferente (ej: Mac Mini): `http://192.168.0.6:56244/v1`
...
> 💡 **Si el servicio local esta en otra computadora**: Ingresa la IP de esa computadora en el campo de URL del servicio. Ejemplo: `http://192.168.0.6:11434` (Ollama), `http://192.168.0.6:1234` (LM Studio). Si el servicio esta vinculado solo a `127.0.0.1` en lugar de `0.0.0.0`, el acceso por IP externa no funcionara — verifica la configuracion de direccion de enlace del servicio.
