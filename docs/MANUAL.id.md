...
- **Base URL**: `http://alamat-proxy:56244/v1`
  ...
  - Jika di mesin lain (misal server Mini): `http://192.168.1.20:56244/v1`
...
> 💡 **Jika layanan lokal berjalan di komputer lain**: Masukkan IP komputer tersebut di field URL layanan. Contoh: `http://192.168.1.20:11434` (Ollama), `http://192.168.1.20:1234` (LM Studio). Jika layanan hanya terikat ke `127.0.0.1` bukan `0.0.0.0`, akses melalui IP eksternal tidak akan berfungsi, jadi periksa alamat binding di pengaturan layanan.
