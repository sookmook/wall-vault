...
> 💡 **Kama huduma ya ndani inafanya kazi kwenye kompyuta nyingine**: Ingiza IP ya kompyuta hiyo kwenye sehemu ya URL ya huduma. Mfano: `http://192.168.1.20:11434` (Ollama), `http://192.168.1.20:1234` (LM Studio)
